 ...
 */
public class NewPostListPageHandler extends PageHandler {
    private String name;
//    private PostList postList;
    public NewPostListPageHandler()
    {
        this.onInit();
    }
    public NewPostListPageHandler(SessionHandler sessionHandler)
    {
...
//        }
    ...
    {
        IPageHandler ph = new NewPostListPageHandler(sessionHandler);
        return ph;
    }
