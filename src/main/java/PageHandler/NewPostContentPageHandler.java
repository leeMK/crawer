 ...
 */
public class NewPostContentPageHandler extends PageHandler {
    private String name = "";
//    private PostList postList;

    public NewPostContentPageHandler() {
        this.onInit();
    }
    public NewPostContentPageHandler(SessionHandler sessionHandler) {
...
//    }
    ...
    {
        IPageHandler ph = new NewPostContentPageHandler(sessionHandler);
        return ph;
    }
