 ...
 */
public class ListForumPostContentPageHandler extends PageHandler {
    private String name = "";
//    private PostList postList;

    public ListForumPostContentPageHandler() {
        this.onInit();
    }
    public ListForumPostContentPageHandler(SessionHandler sessionHandler) {
...
//                        String quFont = quElement.getAttribute();
...
//                        as.setQuestion(an.split("\\n")[0]);
                        as.setQuestion(quElement.getText());
                        try {
...
//                    saveData( result,"/Users/lee/Desktop/ocr/result.xls");
                }catch (Exception e)
                {
                    ...
                    writeObjectToFile(result,"/Users/lee/Desktop/ocr/qizhongji/output/result.txt");
                    writeObjectToFile(mlsit,"/Users/lee/Desktop/ocr/qizhongji/output/mlsit.txt");
                    saveData( mlsit,"/Users/lee/Desktop/ocr/qizhongji/output/mlsit.xls");
                    saveData( result,"/Users/lee/Desktop/ocr/qizhongji/output/result.xls");
                }
...
//    }
    ...
    {
        IPageHandler ph = new ListForumPostContentPageHandler(sessionHandler);
        return ph;
    }
...
//                }
//                rows.createCell(2).setCellValue(as.get(row).getType());
                if (as.get(row).getImage()!=null){
//                    rows.createCell(3).setCellValue(as.get(row).getImage());
